...
CPP_SRCS += \
../eiq/tensorflow-lite/tensorflow/lite/core/api/error_reporter.cpp \
../eiq/tensorflow-lite/tensorflow/lite/core/api/flatbuffer_conversions.cpp \
../eiq/tensorflow-lite/tensorflow/lite/core/api/op_resolver.cpp \
../eiq/tensorflow-lite/tensorflow/lite/core/api/tensor_utils.cpp 
...
eiq/tensorflow-lite/tensorflow/lite/core/api/%.o: ../eiq/tensorflow-lite/tensorflow/lite/core/api/%.cpp eiq/tensorflow-lite/tensorflow/lite/core/api/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-eiq-2f-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-core-2f-api

clean-eiq-2f-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-core-2f-api:
	-$(RM) ./eiq/tensorflow-lite/tensorflow/lite/core/api/error_reporter.d ./eiq/tensorflow-lite/tensorflow/lite/core/api/error_reporter.o ./eiq/tensorflow-lite/tensorflow/lite/core/api/flatbuffer_conversions.d ./eiq/tensorflow-lite/tensorflow/lite/core/api/flatbuffer_conversions.o ./eiq/tensorflow-lite/tensorflow/lite/core/api/op_resolver.d ./eiq/tensorflow-lite/tensorflow/lite/core/api/op_resolver.o ./eiq/tensorflow-lite/tensorflow/lite/core/api/tensor_utils.d ./eiq/tensorflow-lite/tensorflow/lite/core/api/tensor_utils.o

.PHONY: clean-eiq-2f-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-core-2f-api
