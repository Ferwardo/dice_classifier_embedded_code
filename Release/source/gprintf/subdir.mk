...
C_SRCS += \
../source/gprintf/chgui.c 

C_DEPS += \
./source/gprintf/chgui.d 

OBJS += \
./source/gprintf/chgui.o 


# Each subdirectory must supply rules for building sources it contributes
source/gprintf/%.o: ../source/gprintf/%.c source/gprintf/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-gprintf

clean-source-2f-gprintf:
	-$(RM) ./source/gprintf/chgui.d ./source/gprintf/chgui.o

.PHONY: clean-source-2f-gprintf
